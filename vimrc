...
" set global indent spacing = 2
set tabstop=2 softtabstop=2 shiftwidth=2 expandtab autoindent

" set indent spacing for python file
...
" Modify the shape of cursor in different modes
if has("autocmd")
...
" eliminate delay on escape
set timeout ttimeout timeoutlen=3000 ttimeoutlen=50
